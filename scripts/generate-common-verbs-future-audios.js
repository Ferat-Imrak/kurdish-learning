...
const audioFiles = [
  // Infinitives
  { text: "xwarin", filename: "xwarin.mp3" },
  { text: "çûn", filename: "cun.mp3" },
  { text: "kirin", filename: "kirin.mp3" },
  { text: "xwendin", filename: "xwendin.mp3" },
  { text: "hatin", filename: "hatin.mp3" },
  { text: "dîtin", filename: "ditin.mp3" },
  { text: "bihîstin", filename: "bihistin.mp3" },
  { text: "axaftin", filename: "axaftin.mp3" },
  ...
  // hatin conjugations (note: Ew ê bê is irregular)
  { text: "Ez ê werim", filename: "ez-e-werim.mp3" },
  { text: "Tu ê werî", filename: "tu-e-weri.mp3" },
  { text: "Ew ê bê", filename: "ew-e-be.mp3" },
...
async function main() {
  console.log('🎵 Generating audio files for common verbs future tense...\n');
