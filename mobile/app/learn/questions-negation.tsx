...
export default function QuestionsNegationPage() {
  ...
  const progressConfig = {
    totalAudios: 27, // Total unique audios in presentTenseExamples
    hasPractice: true,
    audioWeight: 30,
    timeWeight: 20,
    practiceWeight: 50,
    audioMultiplier: 1.11, // 30% / 27 audios ≈ 1.11% per audio
  };
  ...
  const calculateProgress = (practiceScore?: number) => {
    ...
    const newAudioProgress = Math.min(30, newUniqueAudios * 1.11);
