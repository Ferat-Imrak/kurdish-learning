...
export default function FoodPage() {
  ...
  const progressConfig = {
    totalAudios: 135, // foodItems (106) + mealTimes (3) + foodQuestions (8) + responses (18)
    hasPractice: false, // No practice section
    audioWeight: 50,
    timeWeight: 50,
    audioMultiplier: 0.37, // 50% / 135 audios ≈ 0.37% per audio
  ...
  useEffect(() => {
    ...
    console.log('🚀 Food page mounted, initial progress:', {
