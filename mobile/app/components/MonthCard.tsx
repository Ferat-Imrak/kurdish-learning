...
interface MonthCardProps {
  month: { ku: string; en: string; icon: string; season: string; order: number };
  audioFile: string;
      ...
      >
        <View style={styles.content}>
          <View style={styles.textContainer}>
            <Text style={styles.monthKurdish} numberOfLines={1}>
              {month.ku.charAt(0).toUpperCase() + month.ku.slice(1)}
            </Text>
            <Text style={styles.monthEnglish} numberOfLines={1}>
              {month.en}
            </Text>
          </View>
        </View>
